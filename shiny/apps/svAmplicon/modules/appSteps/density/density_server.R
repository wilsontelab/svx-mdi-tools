...
# [26] "qual2"      "jxnKeys"  "read1Seq" "read1Qual" "read2Seq" "read2Qual" "strand" "dotplotL" "dotplotR"
})
...
bufferedTableServer(
    ...
    id,
    input,
    tableData = moleculeTypeExpansion,
    selection = 'single',
    options = list(
        paging = FALSE
    )
...
moleculeDotPlot <- staticPlotBoxServer(
    ...
    margins = FALSE,
    create = function() {
        makeDotPlot(moleculeDotPlot, moleculeTypeData())
    }
)
